...
public class GridSystemVisuals : MonoBehaviour
{
    ...
    private void UpdateGridVisual()
    {
        ...
        BaseAction selectedUnitAction = UnitActionSystem.Instance.GetSelectedAction();
        ...
        ShowGridPositionList(selectedUnitAction.GetValidActionGridPositionList(), gridVisualType);
    }
